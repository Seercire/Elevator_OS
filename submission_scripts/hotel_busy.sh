#!/bin/bash
#SBATCH --job-name=Elevator_Hotel_Busy
#SBATCH --output=%x.o%j
#SBATCH --error=%x.e%j
...
buildingFile="hotel.bldg"
simulationName="hotel_busy"
simulationTime=275
...
echo -e "\n\nCS4352 Final Project Test Script - Hotel Busy.\n"
